...
download_file https://github.com/Azure/cortana-intelligence-price-optimization-for-retail/raw/master/Manual%20Deployment%20Guide/Scripts/Package%20Installer/lp_solve.tar.gz /tmp/lp_solve.tar.gz
