...
download_file https://github.com/Azure/cortana-intelligence-price-optimization-for-retail/blob/master/Manual%20Deployment%20Guide/Scripts/PackageInstaller/lp_solve.tar.gz /tmp/lp_solve.tar.gz
